            ...
            <section v-if="activeTab === 'editor'" class="tab-panel">
              <div class="setting-row">
                <div class="setting-label">
                  ...
                  <span class="setting-desc">新建项目时的默认分辨�?/span>
                </div>
              ...
              <div class="setting-row">
                <div class="setting-label">
                  <strong>性能监控</strong>
                  <span class="setting-desc">显示帧率 / GPU / 内存悬浮�?/span>
                </div>
                <button
              ...
              <div class="setting-row">
                <div class="setting-label">
                  <strong>启动恢复</strong>
                  <span class="setting-desc">启动时自动恢复上次项�?/span>
                </div>
                <button
            ...
            <section v-if="activeTab === 'autosave'" class="tab-panel">
              <div class="setting-row column">
                <div class="setting-label">
                  ...
                  <span class="setting-desc">{{ autosaveSeconds }} �?范围 1~300)</span>
                </div>
                <input
                  type="range"
                  min="1"
