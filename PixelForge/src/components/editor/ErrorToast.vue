 ...
 *
 * 功能:
 * - �?errorStore 读取 activeError,展示为右上角 Toast
    ...
    >
      ...
      <Transition name="toast-expand">
        <div v-if="expanded" class="toast-detail">
          <div class="detail-row"><span class="detail-label">错误�?/span><code>{{ errorStore.activeError.code }}</code></div>
          <div class="detail-row"><span class="detail-label">来源</span><span>{{ errorStore.activeError.source }}</span></div>
          <div class="detail-row"><span class="detail-label">可恢�?/span><span>{{ errorStore.activeError.recoverable ? '�? : '�? }}</span></div>
