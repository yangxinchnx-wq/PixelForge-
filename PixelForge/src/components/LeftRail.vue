...
const navItems: { tab: LeftNavTab; label: string; icon: string }[] = [
  { tab: 'input', label: '视频', icon: 'PhVideo' },
...
<template>
  <div class="pf-rail">
    ...
    >
      <!-- 自定义导出图标 -->
      <svg v-if="item.icon === 'export'" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        <path d="M12 3v10" />
        <path d="M8 7l4-4 4 4" />
